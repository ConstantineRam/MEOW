...
[AddComponentMenu("Layout/Extensions/Custom Grid Layout Group")]
public class CustomGridLayoutGroup : LayoutGroup
{

  public enum Corner { UpperLeft = 0, UpperRight = 1, UpperCenter = 2, LowerLeft = 3, LowerRight = 4, LowerCenter = 5 }
  ...
  [SerializeField]
  protected bool m_IsFlexibleCellWidth = false;
  public bool IsFlexibleCellWidth { get { return m_IsFlexibleCellWidth; } set { SetProperty(ref m_IsFlexibleCellWidth, value); } }

  [SerializeField]
  protected bool m_IsFlexibleCellHeight = false;
  public bool IsFlexibleCellHeight { get { return m_IsFlexibleCellHeight; } set { SetProperty(ref m_IsFlexibleCellHeight, value); } }
  ...
  [SerializeField]
  protected bool BorderSpacing = false;

  public int ColumnsCount
  {
    get
    {
      return (int) GetCellCount().x;
    }
  }
  ...
  public override void CalculateLayoutInputHorizontal()
  {
    ...
    SetLayoutInputForAxis(
      padding.horizontal + (cellSize.x + spacing.x) * minCount - spacing.x,
      padding.horizontal + (cellSize.x + spacing.x) * preferredCount - spacing.x,
      -1, 0);
  }
  ...
  private void SetCellsAlongAxis(int axis)
  {
    ...
    {
      case 0: cornerX = 0; cornerY = 0; break; //upper left
      case 1: cornerX = 1; cornerY = 0; break; //upper right
      case 2: cornerX = 3; cornerY = 0; break; //upper center
      case 3: cornerX = 0; cornerY = 1; break; //lower left
      case 4: cornerX = 1; cornerY = 1; break; //lower right
      case 5: cornerX = 3; cornerY = 1; break; //lower center
    }
    ...
    Vector2 requiredSpace = new Vector2(
      actualCellCountX * cellSize.x + (actualCellCountX - 1) * spacing_tmp.x,
      actualCellCountY * cellSize.y + (actualCellCountY - 1) * spacing_tmp.y
    );
